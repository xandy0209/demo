...
import { MOCK_PORTRAIT_INDICATORS } from '../constants';
import { StyledInput, StyledButton } from './UI';
import { SettingsIcon, PlusCircleIcon, SearchIcon, RefreshCwIcon, XIcon, EditIcon, TrashIcon, CheckCircleIcon, AlertCircleIcon } from './Icons';

export const PortraitConfigView: React.FC = () => {
    const [indicators, setIndicators] = useState<PortraitIndicator[]>(MOCK_PORTRAIT_INDICATORS);
